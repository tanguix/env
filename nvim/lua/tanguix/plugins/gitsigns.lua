...
return {
  ...
  config = function()
    ...
    -- attach the lsp sever to the current buffer
    ...
    vim.diagnostic.config({
      ...
      virtual_text = {
        prefix = "●", -- Could be '■', '▎', 'x', '●'
        spacing = 4,
        suffix = "", -- Can be used to add custom suffix
        severity = { min = vim.diagnostic.severity.WARN }, -- Only show WARN and ERROR, not INFO/HINT
        format = function(diagnostic)
          return diagnostic.message
        end,
      },
      -- Show only the most severe diagnostic per line
      virtual_lines = false,
